...
Course::Course(string id, string n, int c, int cap, string sch, string instrID)
    : courseID(id), name(n), credits(c), capacity(cap),
    schedule(sch), instructorID(instrID), enrolledCount(0) {}

string Course::getCourseID()      { return courseID; }
string Course::getCourseName()    { return name; }
string Course::getInstructorID()  { return instructorID; }
string Course::getSchedule()      { return schedule; }
int    Course::getCredits()       { return credits; }
int    Course::getCapacity()      { return capacity; }
int    Course::getEnrolledCount() { return enrolledCount; }
bool   Course::isAvailable()      { return enrolledCount < capacity; }
